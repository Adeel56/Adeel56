...
A robust grounding in computer science pillars, systems architecture, and intelligent systems:

* **Systems & Infrastructure:** Parallel & Distributed Computing, DevOps for Cloud Computing, Principles of Operating Systems, Computer Networks
* **Algorithms & Architecture:** Data Structures & Algorithms, Design & Analysis of Algorithms, Object-Oriented Programming (Java), Compiler Construction
* **Data & Intelligent Systems:** Database Systems, Information Security, Machine Learning, Computer Vision

## 🛠️ Tech I Work With
- **Frontend:** React, Next.js, React Native (Expo), TypeScript, Tailwind CSS
- **Backend:** Node.js, Express, Flask, PostgreSQL, Supabase
- **Web3:** Solidity, Foundry, viem, ethers.js, ERC-4337 / ERC-7579, WebAuthn
- **DevOps:** Docker, Kubernetes, GitHub Actions, AWS (EKS), Vercel, Render
- **Languages (Academic/Core):** Java, C++
...
- **LinkedIn:** [adeel-jahangir-](https://www.linkedin.com/in/adeel-jahangir-/)
